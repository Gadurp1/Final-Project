                ...
                <div class="row ">
                        ...
                        <div class="shop-detail-item">
                            ...
                            <div class="sp-wrap">
                                <div class="sp-full-screen">
                                    <a class="cbox-gallary1" href="../{{$slug->img}}">
                                        <img src="../{{$slug->img_detail1}}"  class="col-md-12" alt="">
                                    </a>
                                </div>
                            </div>
                            <!-- End Item Images -->
                    ...
                    <div class="col-md-6">
                        <div class="shop-detail-info">
                            <h1>{{$slug->name}}</h1>
                            <div class="shop-item-price mtb-15 ptb-15"><del class="hidden">$499.00</del><span>${{$slug->price}}</span></div>
                            <hr />
                            {!!$slug->description!!}
                            ...
                            <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                ...
                                <input type="image" src="{{ asset('buy-button.png') }}" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
                                <img alt="" border="0" src="{{ asset('buy-button.png') }}" width="1" height="1">
                            </form>
                        ...
                        <div class="item">
                            <div class="nf-col-padding">
                                <div class="item-box">
                                    ...
                                    <div class="shop-item">
                                        <div class="item-img">
                                            <img src="../{{$related_product->img_detail1}}" />
                                        </div>
                                        <div class="item-mask">
                                            <div class="item-mask-detail">
                                                <div class="item-mask-detail-ele">
                                                    <a class="btn btn-line-xs btn-white-line" href="{{$related_product->download}}"><i class="fa fa-shopping-cart"></i>View Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="shop-item-info">
                                        <a href="shop-detail.html">
                                            <h6 class="shop-item-name">{{$related_product->name}}</h6>
                                        </a>
                                        <div class="shop-item-price"><span>${{$related_product->price}}</span></div>
                                    </div>
                                    <!-- Shop item info -->
                                </div>
                            </div>
